...
url = 'https://catalog.iaf.se/store/1/resource/380'
df = pd.read_csv(url)
...
df.to_csv('/Users/viktorheidmark/Documents/DMSTO24-DS/ovningar/inlämmningsgruppuppgift_2.csv', index=False)

#spara dataframen till en csv fil och skriver ut det i terminalen
print("Data sparad i inlämningsgruppuppgift2.csv")

# laddar ned data
df = pd.read_csv('/Users/viktorheidmark/Documents/DMSTO24-DS/ovningar/inlämmningsgruppuppgift_2.csv')
...
df.to_excel('/Users/viktorheidmark/Documents/DMSTO24-DS/ovningar/inlämningsgruppuppgift2.xlsx', index=True, sheet_name='inlämningsgruppuppgift_2')

print("Processed data has been saved to inlämnningsgruppuppgift2.xlsx")


# # # Histogram för datafördelning för att visa hur datan är fördelad.
plt.figure(figsize=(10, 6))
sns.histplot(df['amount_sek'], bins=20, kde=True)
plt.title('Histogram för datafördelning')
plt.xlabel('age_range_year')
plt.ylabel('Frekvens')
plt.show()
